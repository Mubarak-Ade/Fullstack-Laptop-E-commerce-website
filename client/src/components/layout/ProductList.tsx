            ...
            <div className="flex lg:flex-row flex-col gap-4 items-center p-5 justify-between">
                ...
                >
                    <motion.button
                        ...
                        className={`px-6 py-2 cursor-pointer rounded-full ${active === 'all' ? 'bg-blue-700 text-white ' : 'dark:text-secondary'}`}
                    >
                        All
                    </motion.button>
                    {brands.slice(0, 4).map(brand => (
                        <motion.button
                            ...
                            className={`px-6 py-2 cursor-pointer rounded-full ${active === brand ? 'bg-blue-700 text-white' : 'dark:text-secondary'}`}
                        >
                            {brand}
                        </motion.button>
                    ))}
