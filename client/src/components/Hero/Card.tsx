    ...
    return (
        ...
        >
            ...
            <motion.p
                ...
                className="mt-4 leading-relaxed max-w-md w-full text-lg text-secondary"
            >
                Explore our curated collection of high-performance laptops, technical accessories,
                and professional-grade electronics. Built for the modern creator
            </motion.p>
