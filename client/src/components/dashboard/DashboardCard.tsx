...
export const DashboardCard = ({ title, value, icon, info="N/A" }: Props) => {
    return (
        <div className="bg-light-bg flex justify-between p-5 w-full dark:bg-dark-bg rounded-xl shadow-[0_0_15px] shadow-light-fg dark:shadow-dark-bg border border-light-border dark:border-dark-border">
          <div className="">
