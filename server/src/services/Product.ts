...
import { Product as CreateProductDTO, ProductIdSchema, ProductSlugSchema, UpdateProductDTO } from "../schema/product.schema.js";
import path from "path";
import fs from "fs";

export const createProductService = async ( data: CreateProductDTO, files: Express.Multer.File[] ) => {
...
export const getProductDetailService = async ( param: string ) => {
...
export const deleteProductService = async ( param: string ) => {
...
export const updateProductService = async ( { data, files, productId }: UpdateState ) => {
